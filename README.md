...
**week_after_semester**: Includes **HW3**, **HW6** and **HW7** solutions. **HW3** deals with vortices in superfluids (topics covered include the rotating bucket experiment, BKT transition and vortex-vortex interactions). **HW6** and **HW7** cover the BCS theory of superconductivity (as well as its consequences, e.g. heat capacity of a superconductor and self-consistency equation for the superconducting gap). 
